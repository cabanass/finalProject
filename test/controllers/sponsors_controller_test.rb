...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { company: @sponsor.company, logo: @sponsor.logo } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { company: @sponsor.company, logo: @sponsor.logo } }
